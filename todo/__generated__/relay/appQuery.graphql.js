...
fragment TodoList_user on User {
  todos(first: 2147483647) {
    edges @stream(label: "TodoList_user$stream$TodoList_todos", initialCount: 0) {
      node {
        id
        complete
        ...Todo_todo
    ...
    ... @defer(label: "TodoList_user$defer$TodoList_todos$pageInfo") {
      pageInfo {
        endCursor
        hasNextPage
      }
...
return {
  ...
  "params": {
    "cacheID": "654be248178b7435e4ae4a20bb7608e5",
    "id": null,
    "metadata": {},
    "name": "appQuery",
    "operationKind": "query",
